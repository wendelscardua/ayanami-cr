class AABB
  ...
  def self.surrounding_box(box0 : AABB, box1 : AABB): AABB
    AABB.new(V3.new(box0.minimum.x < box1.minimum.x ? box0.minimum.x : box1.minimum.x,
                    box0.minimum.y < box1.minimum.y ? box0.minimum.y : box1.minimum.y,
                    box0.minimum.z < box1.minimum.z ? box0.minimum.z : box1.minimum.z),
             V3.new(box0.maximum.x > box1.maximum.x ? box0.maximum.x : box1.maximum.x,
                    box0.maximum.y > box1.maximum.y ? box0.maximum.y : box1.maximum.y,
                    box0.maximum.z > box1.maximum.z ? box0.maximum.z : box1.maximum.z))
  end
end
